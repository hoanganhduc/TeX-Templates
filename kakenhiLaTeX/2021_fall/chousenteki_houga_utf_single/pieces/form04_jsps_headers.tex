...
%
\newcommand{\headerfont}{\fontsize{9.5}{9.5}\selectfont}
% ===== Headers =====================================
...
%--------------------------------
	\fancypagestyle{JSPSVeryFirstPageStyle}{% The name is not taken from #1, because 
		\fancyhf{}
		\fancyhead[L]{\hspace{-37pt}\headerfont#2\ Research Proposal Document (forms to be uploaded)\\
				\rule{0pt}{18pt}\\}
%				\rule{0pt}{0pt}\\}
		\fancyhead[R]{\headerfont\textbf{#3\ \thepage}\vspace{-5pt}\\
			\rule{0pt}{0pt}\\}
%		\fancyhead[R]{\headerfont\textbf{#3\ \thepage\\}}
	}
...
%--------------------------------
	\fancypagestyle{JSPSDefaultPageStyle}{%
		\fancyhf{}
		\fancyhead[L]{\headerfont\textbf{[#4\ (continued from the previous page)]}\vspace{-7pt}\\}
		\fancyhead[R]{\headerfont\textbf{#3\ \thepage}\vspace{-5pt}\\
			\rule{0pt}{0pt}\\}
%		\fancyhead[R]{\headerfont\textbf{#3\ \thepage\\}}	
        }
