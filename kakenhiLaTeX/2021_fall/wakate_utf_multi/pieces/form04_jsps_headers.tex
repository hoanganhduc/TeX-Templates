...
%--------------------------------
	\fancypagestyle{JSPSVeryFirstPageStyle}{% The name is not taken from #1, because 
		\fancyhf{}
		\fancyhead[L]{\hspace{-37pt}\headerfont#2\ Research Proposal Document (forms to be uploaded)\\ % 研究計画調書（添付ファイル項目）
				\rule{0pt}{18pt}\\}
%				\rule{0pt}{0pt}\\}
...
%		\fancyhead[L]{\headerfont\textbf{【#4（つづき）\ 】}\vspace{-7pt}\\}
		\fancyhead[L]{\headerfont [#4\ (continued from the previous page)]\vspace{-7pt}\\}
		\fancyhead[R]{\headerfont\textbf{#3\ \thepage}\vspace{-5pt}\\
			\rule{0pt}{0pt}\\}
%		\fancyhead[R]{\headerfont\textbf{#3\ \thepage\\}}	
        }
