...
　(Delete \texttt{\textbackslash #1} and other texts)}%
}
...
　ーー　Noteーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー\\
\begin{small}%
1.	The description in this column is to explain the feasibility of the research plan. 
On citing research achievements (research papers, books, patents, invited talks, etc.) they should be given not as an exhaustive list but as supporting evidence to prove the applicant's ability to conduct the proposed research.\\
